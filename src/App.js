...
export default class App extends Component {
  ...
  onChange(e) {
    ...
    switch (className) {
      ...
      case "current-title":
        this.setState({
          input: { ...this.state.input, currentTitle: e.target.value },
        });
        break;
      case "summary":
        this.setState({
          input: { ...this.state.input, summary: e.target.value },
        });
        break;
      case "Company-Name":
        if (id == 0) {
      ...
      case "Major":
        if (id == 0) {
          this.setState({
            educationInput: { ...updatedEducationInput, major: e.target.value },
          });
        } else {
          this.setState({
            educationInput2: {
      ...
      case "Date-From-Education":
        if (id == 0) {
          this.setState({
            educationInput: {
              ...updatedEducationInput,
              dateFromEducation: e.target.value,
            },
          });
        } else {
          this.setState({
      ...
      case "Date-Until-Education":
        if (id == 0) {
          this.setState({
            educationInput: {
              ...updatedEducationInput,
              dateUntilEducation: e.target.value,
            },
          });
        } else {
          this.setState({
  ...
  submitEvent(e) {
    ...
    const filtered = this.state.view.experience.filter(
      (_, index) => e.target[0].id == index
    )[0];
    ...
    if (this.state.viewChilds.experience?.length == 0) {
      this.state.viewChilds.experience.splice(
        map.get("id0"),
        0,
        <View
          className1="companyName"
          className2="position"
          className3="dateFrom"
          className4="dateUntil"
          className5="details"
          value0={this.state.view.experience[id].get(company)}
          value1={this.state.view.experience[id].get(position)}
          value2={this.state.view.experience[id].get(dateFrom)}
          value3={this.state.view.experience[id].get(dateUntil)}
          value4={this.state.view.experience[id].get(details)}
        ></View>
      );
      console.log("if");
  ...
  removeExperience(e) {
    ...
    this.setState({
      childs: {
        experience: this.state.childs.experience.filter(
  ...
  addExperience(e) {
    ...
    this.setState({
      childs: {
        experience: this.state.childs.experience.concat(
          <Experience
            onSubmit={this.onSubmit}
            onChange={this.onChange}
            value1={this.state.experienceInput.company}
            value2={this.state.experienceInput.position}
            value3={this.state.experienceInput.dateFrom}
            value4={this.state.experienceInput.dateUntil}
            value5={this.state.experienceInput.details}
            initialClickEvent={this.addExperience}
            clickEvent={this.addExperience}
          ></Experience>
        ),
  ...
  onSubmit(e) {
    e.preventDefault();
    const { name, email, phone, currentTitle, summary } = this.state.input;
    const { company, position, dateFrom, dateUntil, details } =
      this.state.experienceInput;
    const { school, major, dateFromEducation, dateUntilEducation, location } =
    ...
    this.setState({
      viewChilds: {
        ...
        experience: this.state.inputs.experience.concat(
          company,
          position,
          dateFrom,
          dateUntil,
        ...
        experience2: this.state.inputs.experience2.concat(
          this.state.experienceInput2.company,
          this.state.experienceInput2.position,
          this.state.experienceInput2.dateFrom,
          this.state.experienceInput2.dateUntil,
          this.state.experienceInput2.details
        ),
        education: this.state.inputs.education.concat(
          school,
          major,
          dateFromEducation,
          dateUntilEducation,
      ...
      <>
        <div className="resume-form">
          ...
          <Experience
            ...
            onSubmit={this.onSubmit}
            onChange={this.onChange}
            value1={this.state.experienceInput2.company}
            value2={this.state.experienceInput2.position}
            value3={this.state.experienceInput2.dateFrom}
            value4={this.state.experienceInput2.dateUntil}
            value5={this.state.experienceInput2.details}
            initialClickEvent={this.addExperience}
            clickEvent={this.addExperience}
          ></Experience>
          ...
          <Education
            ...
            onSubmit={this.onSubmit}
            onChange={this.onChange}
            value1={this.state.educationInput.school}
            value2={this.state.educationInput.major}
            value3={this.state.educationInput.dateFromEducation}
            value4={this.state.educationInput.dateUntilEducation}
            value5={this.state.educationInput.location}
            initialClickEvent={this.addExperience}
            clickEvent={this.addExperience}
          ></Education>
        ...
        <div className="resume-view">
          {
            <PersonalView
              className1="personal-name"
              className2="email"
              className3="phone-number"
              className4="current-title"
              className5="summary"
              value0={this.state.input.name}
              value1={this.state.input.email}
              value2={this.state.input.phone}
              value3={this.state.input.currentTitle}
              value4={this.state.input.summary}
            ></PersonalView>
          }
          ...
          <View
            ...
            className4="dateUntil"
            className5="details"
            value0={this.state.experienceInput.company}
            value1={this.state.experienceInput.position}
            value2={this.state.experienceInput.dateFrom}
            value3={this.state.experienceInput.dateUntil}
            value4={this.state.experienceInput.details}
          ></View>
          <View
            className1="companyName"
            className2="position"
            ...
            className4="dateUntil"
            className5="details"
            value0={this.state.experienceInput2.company}
            value1={this.state.experienceInput2.position}
            value2={this.state.experienceInput2.dateFrom}
            value3={this.state.experienceInput2.dateUntil}
            value4={this.state.experienceInput2.details}
          ></View>
          <EducationView
            className1="companyName"
            className2="position"
            ...
            className4="dateUntil"
            className5="details"
            value0={this.state.educationInput.school}
            value1={this.state.educationInput.major}
            value2={this.state.educationInput.dateFromEducation}
            value3={this.state.educationInput.dateUntilEducation}
            value4={this.state.educationInput.location}
          ></EducationView>
        </div>
      </>
    );
